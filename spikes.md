...
- Decision:
- Notes:
- Architecture.md impact: none expected — confirms §0 as written.
...
- Architecture.md impact: §12 — update if the workflow's structure changed from what's above (e.g. different job names, added a staging environment).
...
- Decision:
- Notes:
- Architecture.md impact: §3 — copy back any changes made here.
